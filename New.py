...
helpMessage ="""ÃÑĨM̃Ẽ B̃ÕT̃ C̃ỸB̃ẼR̃ S̃C̃R̃ĨM̃Ẽ ν3.2
...
Help3 ="""<  Command Protect  >
=> Guest On
=> Mad On   
=> Vk @   
 ==[ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴀᴅᴍɪɴ ᴀɴᴅ ᴄʀᴇᴀᴛᴏʀ]==
"""
Help4 ="""<  Command Creator  >
=> Admin Add @
=> Admin remove @ 
=> Adminlist
...
admin=["uec6d62c3e4a61f033332bc1d86133e49"]
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    ky.sendText(msg.to,"Papay ler")
                                    ky.sendText(msg.to,"Done, See u :*")
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"sayang ")
                ki.sendText(msg.to,"opo koe kerungu jerit e atiku")
                kk.sendText(msg.to,"mengharap engkau kembali")
                cl.sendText(msg.to,"sayang")
                ki.sendText(msg.to,"nganti memutih rambutku")
                kk.sendText(msg.to,"rabakal luntur tresnoku")
                cl.sendText(msg.to,"wes tak cobo ngelalekne jeneng mu seko atiku ")
                ki.sendText(msg.to,"sak tetane ra ngapusi isi tresno slirahmu")
                kk.sendText(msg.to,"duko pujane ati nanging koe ora ngerti")
                cl.sendText(msg.to,"kowe wes tak wanti wanti")
                ki.sendText(msg.to,"malah jebul saiki koe mblen janji janji")
                kk.sendText(msg.to,"jare sehidup semati nanging opo bukti")
                cl.sendText(msg.to,"koe medot tresnoku demi wong lio")
                ki.sendText(msg.to,"yowes rapopo insyallah aku iso, lilo")
                kk.sendText(msg.to,"meh sembat kaleh sinten nyen sampun mekaten")
                cl.sendText(msg.to,"merana uripku")
                ki.sendText(msg.to,"oa oe")
                kk.sendText(msg.to,"aku welasno kangmas,aku mesakno aku")
                cl.sendText(msg.to,"aku nangis,ngant metu eluh getih putih")
                ki.sendText(msg.to,"sayang ")
                kk.sendText(msg.to,"opo koe kerungu jerit e atiku")
                cl.sendText(msg.to,"mengharap engkau kembali")
                ki.sendText(msg.to,"sayang")
                kk.sendText(msg.to,"nganti memutih rambutku")
                cl.sendText(msg.to,"rabakal luntur tresnoku")
                ki.sendText(msg.to,"gua yakin yang baca pada nyanyi")
                kk.sendText(msg.to,"udah ngaku aja wkwk")
                cl.sendText(msg.to,"kgk ngaku lu?")
                ki.sendText(msg.to,"tar gua nyanyi lagi loh")
                kk.sendText(msg.to,"engga deng males gua")
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                jawab = ("Ya","Tidak","Mungkin","Bisa jadi","Diem anjing nanya trus")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)
#-----------------------------------------------
            elif "Kapan " in msg.text:
                tanya = msg.text.replace("Kapan ","")
                jawab = ("Besok","Nanti","Sekarang","Satu jam lagi","Lusa","Minggu depan","Satu tahun lagi","Aku tidak sanggup meramalkan")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)
#-----------------------------------------------
            elif "Kenapa " in msg.text:
                tanya = msg.text.replace("Kenapa ","")
                jawab = ("Ga apa apa","Ga tau","Diem ih nanya terus","ada deh","Diem anjing nanya trus")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)
#-----------------------------------------------
...
#-------------------------------------------------------------
		  ...
		  if msg.from_ in admin:
		    if msg.toType == 2:
			    ...
			    pass
#-------------------------------------------------------------
        elif "@Pancy"+cl.getProfile().displayName in msg.text:
                try:
                    tanya = msg.text.replace("@Pancy"+cl.getProfile().displayName,"")
                    jawab = ("Jgn Tag Si "+cl.getProfile().displayName+"!!","Berisik jgn tag si "+cl.getProfile().displayName+" dia masih sibuk")
                    jawaban = random.choice(jawab)
                    cl.sendText(msg.to,jawaban)
