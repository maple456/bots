...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto like by: http://line.me/ti/p/~alwijaya11")
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "u4b0e00ae8e366fc33d645ac5de9acfcf"
                    if op.param2 in OWN:
